...
test("new package declares schema1 through 6 and hashes the standalone guard; immutable output cannot be overwritten", async () => {
  ...
  expect(manifest.stateSchemaVersions).toEqual([1, 2, 3, 4, 5, 6]);
