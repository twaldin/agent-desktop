...
globalThis.fetch = Object.assign(async (input: Parameters<typeof fetch>[0], init?: Parameters<typeof fetch>[1]) => {
  ...
  if (url.hostname !== '127.0.0.1') throw new Error('Outbound provider/network fetch forbidden in Composer flow fixture.');
...
await writeFile(join(fixture, 'project', 'README.md'), '# Composer flow fixture\n');
