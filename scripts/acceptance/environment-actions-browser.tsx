...
Object.assign(window, {
  ...
  awaitPrimary: async () => { await wait(() => { const button = document.querySelector<HTMLButtonElement>('[aria-label="Run: Count run"]'); return Boolean(button && !button.disabled); }, "primary action without opening menu"); checks.push("primary configured action loaded before opening the Actions menu"); return state(); },
