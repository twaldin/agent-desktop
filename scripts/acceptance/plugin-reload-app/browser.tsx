...
const documentId = crypto.randomUUID(),
  api = window.pluginReloadAppFixture;
...
Object.assign(window, {
  pluginReloadAppCall(method: string, args?: unknown[]) { return api.call(method, args); },
  pluginReloadAppTarget(selector: string, text?: string) {
