...
const bridge: Partial<DesktopBridge> = {
  ...
  ...(features.suggested ? {
    ...
    controlBrowser: (id: string, request: unknown, host: string) => api.call('controlBrowser', [id, request, host]),
    getBrowserFrame: (id: string, target: unknown, host?: string) => api.call('getBrowserFrame', [id, target, host]),
    openHtmlPreview: (sessionId: string, request: unknown, hostId: string) => api.call('openHtmlPreview', [sessionId, request, hostId]),
    releaseHtmlPreview: (sessionId: string, leaseId: string, hostId: string) => api.call('releaseHtmlPreview', [sessionId, leaseId, hostId]),
  ...
  ...(features.mcp ? {
    ...
    openExternal: (url: string) => api.call('openExternal', [url]),
  } : {}),
  ...
  respondInteraction: (id, interactionId, response, host) => api.call('respondInteraction', [id, interactionId, response, host]),
