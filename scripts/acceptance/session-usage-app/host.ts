...
if (
  ...
  throw new Error("An isolated provider-usage App environment is required.");
...
await writeFile(join(fixture, "agent", "models.yml"), JSON.stringify({ providers: { "usage-fixture": {
...
globalThis.fetch = Object.assign(async (input: RequestInfo | URL, init?: RequestInit) => {
  ...
  if (url.hostname !== "127.0.0.1") throw new Error("Nonlocal network is forbidden in the provider-usage App fixture.");
