...
const documentId = crypto.randomUUID(),
  api = window.usageCommandAppFixture;
...
Object.assign(window, {
  usageCommandAppCall(method: string, args?: unknown[]) { return api.call(method, args); },
  usageCommandAppTarget(selector: string, text?: string) {
