...
export function ComposerSelections({ data, draft, session, disabled, onChange, accounts }: {
  accounts?: { bridge: DesktopBridge; hostId: string; localHostId?: string; connected: boolean };
