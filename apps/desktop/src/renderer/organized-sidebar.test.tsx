...
function fixture() {
  ...
  const Component = new Function("createElement", "Fragment", "useState", "useRef", "useEffect", "useLayoutEffect", "createPortal", "sidebarItemKey", "Icon", "SidebarPinIcon", "ProjectMarker", "projectColor", "PROJECT_APPEARANCE_COLORS", "PROJECT_APPEARANCE_ICONS", "ProjectMarkerPicker", `${compiled}; return OrganizedSidebar;`)
    (createElement, Fragment, useState, useRef, () => {}, () => {}, (node: ReactNode) => node, sidebarItemKey, () => null, () => null, () => null, () => "#000", PROJECT_APPEARANCE_COLORS, PROJECT_APPEARANCE_ICONS, ProjectMarkerPicker);
