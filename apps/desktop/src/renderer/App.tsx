...
export function App() {
  ...
  const transcriptLinkActions: TranscriptLinkActions = {
    ...
    openFile: file => {
      ...
      dock.openFile(file.path, hostId, workspaceTarget!);
    },
  };
