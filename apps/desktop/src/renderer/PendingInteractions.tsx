...
export function InteractionCard({ hostId, request, disabled, sending, respond }: { hostId: string; request: OmpInteraction; disabled: boolean; sending: boolean; respond(response: OmpInteractionResponse): Promise<void> }) {
