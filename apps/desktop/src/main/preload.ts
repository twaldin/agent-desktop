...
const bridge: DesktopBridge = {
  pullRequestWrites: createPullRequestWritesBridge((channel, ...args) => ipcRenderer.invoke(channel, ...args)),
  ...
  getTranscriptImage: (sessionId, nativeEntryId, blockIndex, hostId, source) => ipcRenderer.invoke("host:transcript-image", sessionId, nativeEntryId, blockIndex, hostId, source),
  ...
  getDapConfiguration: (target, hostId) => ipcRenderer.invoke("host:dap-read", target, hostId),
  getLspConfiguration: (target, hostId) => ipcRenderer.invoke("host:lsp-read", target, hostId),
  mutateDapConfiguration: (target, mutation, hostId) => ipcRenderer.invoke("host:dap-mutate", target, mutation, hostId),
  mutateLspConfiguration: (target, mutation, hostId) => ipcRenderer.invoke("host:lsp-mutate", target, mutation, hostId),
  ...
  listNativeSessionImports: (hostId, requestId) => ipcRenderer.invoke("host:session-import-list", hostId, requestId),
  inspectNativeSessionImport: (hostId, candidateId, requestId) => ipcRenderer.invoke("host:session-import-inspect", hostId, candidateId, requestId),
  cancelNativeSessionImportRead: (hostId, requestId) => ipcRenderer.invoke("host:session-import-cancel", hostId, requestId),
  prepareNativeSessionImport: (hostId,input,requestId) => ipcRenderer.invoke("host:session-import-prepare",hostId,input,requestId),
  admitNativeSessionImport: (hostId,input) => ipcRenderer.invoke("host:session-import-admit",hostId,input),
  getNativeSessionImportOutcome: (hostId,commandId,requestId) => ipcRenderer.invoke("host:session-import-outcome",hostId,commandId,requestId),
  ...
  getPlanEditorCapabilities: (sessionId, hostId) => ipcRenderer.invoke("host:plan-editor-capabilities", sessionId, hostId),
  startPlanEditor: (request, hostId) => ipcRenderer.invoke("host:plan-editor-start", request, hostId),
  getPlanEditorStatus: (request, hostId) => ipcRenderer.invoke("host:plan-editor-status", request, hostId),
  ...
  listTodoEditors: (sessionId, hostId, cursor) => ipcRenderer.invoke("host:todo-editor-list", sessionId, hostId, cursor),
  getTodoEditorCapabilities: (sessionId, hostId) => ipcRenderer.invoke("host:todo-editor-capabilities", sessionId, hostId),
  startTodoEditor: (request, hostId) => ipcRenderer.invoke("host:todo-editor-start", request, hostId),
  getTodoEditorStatus: (request, hostId) => ipcRenderer.invoke("host:todo-editor-status", request, hostId),
  ...
  browserAutocomplete: (sessionId, request, hostId) => ipcRenderer.invoke("host:browser-autocomplete", sessionId, request, hostId),
