...
export type WorkerEvent = { type: "plan_changed" } | { type: "todos_changed" } | NativeEventMetadata | OmpBridgeEvent | { type: "queued_messages_changed"; snapshot: NativeQueuedMessagesSnapshot };
