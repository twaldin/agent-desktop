...
These are source-level tests and hidden Electron captures of this app. They do not establish installed behavior, native provider execution, physical cross-device docking, or live reference parity.
...
Build 16 is packaged at `out/desktop-release16/Agent Desktop.app`; signing, native imports, tmux validation and all 106 host-manifest file hashes pass. Host archive SHA-256: `30ec5af2d3faf246536e2280c057311fd1604c3dc5f64f50f76069948769942d`. It supports state schemas 1–3. This source checkpoint is not installed on the user's machines. Home remains desktop/host 14; Work and Deckbox remain 13 until a separately verified upgrade.
