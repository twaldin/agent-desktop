...
export type HostEvent =
  ...
  | { sequence: number; type: "session.fork"; sessionId: string; snapshot: import("./session-fork").SessionForkSnapshot }
...
export interface DesktopBridge extends TerminalBridge, Partial<NativeTerminalBridge>, Partial<TerminalCreationBridge> {
  ...
  getDapConfiguration(target?: WorkspaceTarget, hostId?: string): Promise<import("./native-dap").NativeDapCatalog>;
  mutateDapConfiguration(target: WorkspaceTarget | undefined, mutation: import("./native-dap").NativeDapMutation, hostId?: string): Promise<import("./native-dap").NativeDapCatalog>;
  ...
  getSessionTree?(sessionId: string, hostId: string, commandId?: string): Promise<import("./session-tree").SessionTreeResponse>;
  getSessionTodos?(sessionId: string, hostId: string, commandId?: string): Promise<import("./session-todos").SessionTodosResponse>;
